...
<body class="container mx-auto">
  ...
  <div id="generic_alert" style="visibility:hidden" class="flex items-center p-4 mb-4 ml-32 mr-32 rounded-lg text-blue-800 border-t-4 border-blue-300 bg-blue-50" role="alert">
    ...
    <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center h-8 w-8" aria-label="Close" onclick="hideAlert();">
