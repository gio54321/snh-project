...
<div class="flex flex-col items-center justify-center mt-10 mb-10">
    ...
    <div class="p-8 border-2 border-gray-200 border-dashed rounded-lg w-full md:w-2/5 mx-4">
        <form class="max-w-sm mx-auto" action="/checkout/payment.php" method="post">
            ...
            <div class="mb-5">
                <label for="card_number" class="block mb-2 text-sm font-medium text-gray-900">Card Number</label>
                <input type="card_number" id="card_number" name="card_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="9000 6000 0000 0000" required>
            </div>
            <div class="mb-5">
                <label for="date" class="block mb-2 text-sm font-medium text-gray-900">Expiration Date</label>
                <input type="expiry_date" id="date" name="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="03/28" required>
            </div>
            <div class="mb-5">
                <label for="secret_code" class="block mb-2 text-sm font-medium text-gray-900">Secret Code</label>
                <input type="secret_code" id="secret_code" name="secret_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="•••" required>
            </div>
