...
<div class="flex flex-col items-center justify-center mt-10 mb-10">
    <ol class="flex items-center w-96 mb-10">
        ...
        <li class="flex w-full items-center text-blue-600">
            <span class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12">
    ...
    <div class="p-8 border-2 border-gray-200 rounded-lg w-full md:w-2/5 mx-4 mt-10">
        ...
        <div class="mb-5">
            ...
            <label class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
